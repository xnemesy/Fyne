    ...
    return InteractiveTutorial(
      ...
      steps: [
        TutorialStep(
          ...
          description: 'Qui puoi vedere tutte le tue transazioni organizzate per data. Scorri per esplorare.',
          icon: Icons.receipt_long,
          actionHint: 'Scorri verso il basso per vedere le tue transazioni',
        ),
        TutorialStep(
          title: 'Aggiungi una Transazione',
          description: 'Tocca il pulsante + in basso a destra per registrare una nuova entrata o uscita.',
        ...
        TutorialStep(
          ...
          description: 'Usa i filtri in alto per trovare rapidamente specifiche transazioni o categorie.',
          icon: Icons.filter_list,
          actionHint: 'Prova a toccare l\'icona filtro',
        ),
        TutorialStep(
          title: 'Dettagli Transazione',
          description: 'Tocca una transazione per vederne i dettagli completi, modificarla o eliminarla.',
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            FeatureDiscovery(
              ...
              description: 'Usa questo pulsante per filtrare le transazioni per data, categoria o importo.',
              icon: Icons.filter_list,
              child: IconButton(
          ...
          itemBuilder: (context, index) {
            ...
            if (index == 0) {
              return FeatureDiscovery(
                ...
                description: 'Tocca una transazione per vedere tutti i dettagli, modificarla o eliminarla.',
        ...
        floatingActionButton: FeatureDiscovery(
          ...
          description: 'Tocca qui per registrare una nuova entrata o uscita. I dati saranno cifrati automaticamente.',
          icon: Icons.add_circle_outline,
    ...
    return InteractiveTutorial(
      ...
      steps: [
        TutorialStep(
          ...
          description: 'Qui vedi il saldo attuale e lo storico movimenti di questo conto.',
          icon: Icons.account_balance,
        ),
        TutorialStep(
          title: 'Aggiorna il Saldo',
          description: 'Tocca il saldo per aggiornarlo manualmente se necessario.',
          icon: Icons.edit,
          actionHint: 'Tocca l\'importo in alto',
        ),
        TutorialStep(
          title: 'Movimenti Recenti',
          description: 'Scorri per vedere tutte le transazioni associate a questo conto.',
          icon: Icons.history,
        ),
      ],
      onComplete: () {
...
final tutorialStateProvider = StateNotifierProvider<TutorialStateNotifier, Map<String, bool>>(
